...
public class GlideRoundTransform implements Transformation<Bitmap> {
    ...
    public GlideRoundTransform(Context context, int radius, int margin, String color, int border) {
    ...
    public Resource<Bitmap> transform(@NonNull Context context, Resource<Bitmap> resource, int outWidth, int outHeight) {
        ...
        bitmap= TransformationUtils.centerCrop(mBitmapPool,source,outWidth,outHeight);
