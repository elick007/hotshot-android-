 ...
 * <li>Default: {@link ExoPlayerControlView#DEFAULT_REPEAT_TOGGLE_MODES}
 * </ul>
...
public class ExoPlayerControlView extends FrameLayout {
    ...
    public ExoPlayerControlView(
        ...
        closeButton = findViewById(R.id.exo_control_view_back);
        if (closeButton != null) {
            closeButton.setOnClickListener(componentListener);
        }
        moreButton = findViewById(R.id.exo_control_view_more);
        if (moreButton != null) {
            moreButton.setOnClickListener(componentListener);
        }
    ...
    public void setInvisibleFlag(boolean b){
        invisibleFlag=b;
    }
    /**
    ...
    private final class ComponentListener extends Player.DefaultEventListener
        ...
        public void onClick(View view) {
            if (player != null) {
                ...
                } else if (moreButton == view) {
                    if (additionControlViewListener != null) {
                        additionControlViewListener.onClickMoreButton();
                    }
                } else if (fullScreenButton == view) {
                    isFullScreen = additionControlViewListener.onClickFullscreenButton();
                    changeFullScreenImage(isFullScreen);
                }
            }
            hideAfterTimeout();
        }
    ...
    private AdditionControlViewListener additionControlViewListener;

    public void setAdditionControlViewListener(AdditionControlViewListener additionControlViewListener) {
        this.additionControlViewListener = additionControlViewListener;
    }

    public AdditionControlViewListener getAdditionControlViewListener() {
        return additionControlViewListener;
    }


    public interface AdditionControlViewListener {
        void onClickCloseButton();

        void onClickMoreButton();

        boolean onClickFullscreenButton();
    }
}
