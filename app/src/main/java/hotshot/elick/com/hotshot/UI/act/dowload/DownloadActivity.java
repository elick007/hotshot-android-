package hotshot.elick.com.hotshot.UI.act.dowload;
...
//            }
    ...
    public static class TasksManager {
        ...
        public TasksManagerModel addTask(final String url, String name) {
            return addTask(url, createPath(url), name);
        }
    ...
    private static class TasksManagerDBController {
        ...
        private TasksManagerDBController() {
            TasksManagerDBOpenHelper openHelper = new TasksManagerDBOpenHelper(MyApplication.deContext);
